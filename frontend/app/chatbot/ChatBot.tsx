    ...
    <>
      ...
      <button
        ...
        className={`fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-50 w-12 h-12 sm:w-14 sm:h-14 rounded-full flex items-center justify-center shadow-2xl transition-all duration-500 hover:scale-110 active:scale-95 ${
          isOpen
            ...
            : "bg-linear-to-br from-[#0f4c5c] to-[#1b263b]"
        }`}
      ...
      >
        <div className="bg-white/95 backdrop-blur-2xl rounded-lg sm:rounded-lg shadow-[0_20px_60px_rgba(0,0,0,0.15)] border border-[#35838D]/40 overflow-hidden flex flex-col h-[min(480px,calc(100vh-7rem))] sm:h-[min(500px,calc(100vh-8rem))]">
          {/* Header */}
          <div className="bg-linear-to-r from-[#0f4c5c] to-[#1b263b] px-4 py-3 sm:px-5 sm:py-3.5 flex items-center gap-3 shrink-0">
          ...
          <div className="flex-1 overflow-y-auto px-3 py-3 space-y-3 scrollbar-thin">
                ...
                >
                  <div
                    className={`px-3 py-2 rounded-md text-xs leading-relaxed whitespace-pre-line ${
                      msg.sender === "user"
                        ? "bg-linear-to-br from-[#0f4c5c] to-[#1b263b] text-white rounded-br-sm shadow-sm"
            ...
            {isTyping && (
              <div className="flex gap-2 items-end">
                <div className="w-6 h-6 bg-linear-to-br from-[#0f4c5c] to-[#1b263b] rounded-lg flex items-center justify-center shrink-0 shadow-sm">
                  <Bot className="w-3 h-3 text-[#35838D]" />
                </div>
          ...
          <div className="px-3 py-2.5 sm:px-4 sm:py-3 bg-white/80 backdrop-blur-xl border-t border-[#35838D]/20 shrink-0">
            ...
            >
              ...
              <button
                type="submit"
                disabled={!input.trim()}
                className="w-9 h-9 sm:w-10 sm:h-10 bg-linear-to-br from-[#0f4c5c] to-[#1b263b] rounded-md flex items-center justify-center text-white hover:brightness-110 transition-all disabled:opacity-30 disabled:cursor-not-allowed shadow-md active:scale-95 shrink-0"
              >
